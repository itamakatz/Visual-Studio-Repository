...
namespace FloodFill2
{
	...
	public class The_Code_Class : AbstractFloodFiller
	{

		FloodFillRangeQueue ranges = new FloodFillRangeQueue();

		public The_Code_Class() : base() { }
		public The_Code_Class(EditableBitmap bitmap) : base(bitmap) { }
		public The_Code_Class(AbstractFloodFiller configSource) : base(configSource) { }
